...
def login():
    ...
    elif usernameEntry.get()=='Pranathi' and passwordEntry.get()=='1234':
...
loginButton=Button(loginFrame,text='Login',font=('times new roman',15,'bold'),width=15,fg='white',bg='cornflowerblue',cursor='hand2',command=login)
